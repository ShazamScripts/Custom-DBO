...
bugMap["macro"] = macro(storage["scrollBars"]["macroDelay"] or 50, "Bug Map", function(self)
	if (
...
-- FIX (Slow macro): mesma causa do "Bug Map" acima -- 1ms e mais apertado
-- do que o motor consegue honrar, entao qualquer variacao normal disparava
-- o aviso. 15ms e suficiente pra filtrar teclas seguradas sem atraso notavel.
macro(15, function()
...
-- FIX (Slow macro): mesma causa das outras -- ["timeout"] = 1 deixava o
-- limite de aviso 100x mais apertado que o padrao do bot, gerando "Slow
-- macro" por qualquer oscilacao normal ao filtrar pressed_data/holding_keys.
