...
local mainMacro = macro(1, "Escadas", function()
...
-- FIX (Slow macro): ["timeout"] = 1 forcava o aviso "Slow macro" a
-- disparar sempre que essa macro passasse de 1ms, mesmo rodando a cada
-- 1ms so para enfileirar verifyTiles. O trabalho pesado (varredura de
-- tiles/pathfinding) ja roda em pedacos via Queue_call, entao o padrao do
-- bot e suficiente aqui.
