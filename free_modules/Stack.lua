...
-- FIX (Slow macro): 1ms nunca e honrado pelo motor. 15ms mantem a
-- resposta ao segurar Alt+direcao praticamente instantanea.
stackOnMonsters["executeMacro"] = macro(15, function()
