...
-- FIX (Slow macro): rodava a 1ms, o que o motor nunca honra de verdade
-- (gerando aviso a toa). 15ms (66x/s) continua rapido o bastante pra
-- reagir a queda de vida/mana sem atraso perceptivel.
macro(15, function()
