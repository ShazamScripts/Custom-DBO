...
-- FIX (Slow macro): 1ms e mais rapido do que o motor consegue chamar a
-- funcao de novo, entao qualquer oscilacao normal virava aviso. 15ms
-- mantem o anuncio de ataque no canal praticamente instantaneo.
comboLeader["macro"] = macro(15, function(self)
...
-- FIX (Slow macro): so garante que voce esta nos canais de guild/party,
-- nao precisa rodar a 1ms. 100ms (10x por segundo) e mais que suficiente.
