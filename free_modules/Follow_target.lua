...
-- FIX (Slow macro): 1ms e mais apertado que o motor consegue honrar.
-- 15ms mantem a resposta rapida ao seguir o alvo, sem falso aviso.
macro(15, function()
    if (FollowAttack["mainMacro"]["isOff"]()) then return; end
...
-- FIX (Slow macro): so guarda o id do alvo atual, 15ms e imperceptivel.
macro(15, function()
    local target = g_game["getAttackingCreature"]();
