...
-- FIX (Slow macro): fallback de "or 1" ainda podia cair em 1ms se
-- macroDelay nao estivesse setado por algum motivo. "or 50" garante um
-- minimo seguro mesmo nesse caso raro.
macro(storage["scrollBars"] and storage["scrollBars"]["macroDelay"] or 50, battleFilter["main"]);
