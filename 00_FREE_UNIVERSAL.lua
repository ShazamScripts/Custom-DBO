...
for _, file in ipairs({
    "Battle_filter.lua",
    -- "Storage.lua" -- REMOVIDO: substituido pelo character_storage.lua,
    -- que ja cobre tudo que esse modulo fazia (e mais), sem duplicar
    -- arquivo por personagem nem desincronizar o _configs do CaveBot.
}) do
    loadInTab("Main", file)
end
